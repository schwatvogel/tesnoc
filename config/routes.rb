ActionController::Routing::Routes.draw do |map|
	...
	#map.hosts   "/hosts",	:controller => 'pages', :action => 'hosts'
	#map.services   "/services",:controller => 'pages', :action => 'services'
	map.tac   "/tac",:controller => 'livestatus', :action => 'tac'
	map.monitor "/monitor", :controller => 'livestatus',:action => 'view'
	map.impressum '/impressum', :controller => 'pages', :action => 'impressum'
	map.resources :livestatus
	map.resources :users
	map.resources :switches
	map.resources :switchports
